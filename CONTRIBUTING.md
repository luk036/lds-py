...
`lds-py` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/lds-py
[issue tracker]: https://github.com/<USERNAME>/lds-py/issues
